/*
  ...
  2. Purpose
    ...
    - Creates realistic examples for users to understand the platform
*/
...
BEGIN
  ...
  WITH rounds AS (
    ...
    VALUES
      ...
      (sde_amazon_id, 'Onsite - Loop', 'A 45-minute technical interview with coding and behavioral questions.', 'Hard')
    RETURNING id
  )
  INSERT INTO interview_tips (round_id, tip)
  SELECT id, tip FROM rounds, unnest(ARRAY[
